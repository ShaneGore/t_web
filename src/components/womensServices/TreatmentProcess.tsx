      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-semibold text-gray-900 mb-4">
            How Hormone Therapy Works for Women
          </h2>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Get the care you need in three simple steps, all with expert support
            from our dedicated women's health team.
          </p>
        </div>
          ...
          1
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Complete Assessment</h3>
              <p className="text-gray-600 mb-6">
                ...
                captures your unique hormonal needs.
              </p>
              <div className="rounded-md bg-white p-4 border border-teal-100">
          ...
          2
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Meet Your Provider</h3>
              <p className="text-gray-600 mb-6">
                ...
                personalized treatment plan tailored to your body's needs.
              </p>
              <div className="rounded-md bg-white p-4 border border-teal-100">
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-center">
          ...
          3
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Start Treatment</h3>
              <p className="text-gray-600 mb-6">
                ...
                monitoring your progress for adjustments when needed.
              </p>
              <div className="rounded-md bg-white p-4 border border-teal-100">
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-center">
